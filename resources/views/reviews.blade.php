            ...
            @auth
                ...
                <form action="" method="post">
                    ...
                    <div class="rating-area">
                        ...
                        <input type="radio" id="star-0" name="rating" value="0">
                    </div>
                    <button type="submit" class="btn btn-success">Оставить отзыв</button>
                </form>
            @endauth
            <div class="container m-5">
                <h1>Отзывы наших клиентов ({{$list}})</h1>
                <div class="row">
                                        ...
                                        <div class="col-lg-4 mt-3">
                                            ...
                                            <p class="mt-2">
                                                @for($i=$review->rating;$i>0;$i--)
                                                    <svg width="25px" height="25px" viewBox="-2.4 -2.4 28.80 28.80"
                                                         fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <g id="SVGRepo_bgCarrier" stroke-width="0">
                                                            <rect x="-2.4" y="-2.4" width="28.80" height="28.80"
                                                                  rx="14.4"
                                                                  fill="#ec947e" strokewidth="0"></rect>
                                                        </g>
