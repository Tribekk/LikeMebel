    ...
    <div class="content">
        ...
        <div class="cards">
            <div class="card text-white bg-dark mb-3">
                ...
                <div class="btn btn-warning"><a href="{{ route('kitchen') }}">Подробнее-></a></div>
            </div>
            <div class="card text-white bg-dark mb-3">
                ...
                <div class="btn btn-warning"><a href="{{ route('bathroom') }}">Подробнее-></a></div>
            </div>
            <div class="card text-white bg-dark mb-3">
                ...
                <div class="btn btn-warning"><a href="{{ route('bedroom') }}">Подробнее-></a></div>
            </div>
        </div>
        <div class="cards">
            <div class="card text-white bg-dark mb-3">
                ...
                <div class="btn btn-warning"><a href="{{ route('wardrobe') }}">Подробнее-></a></div>
            </div>
            <div class="card text-white bg-dark mb-3">
                ...
                <div class="btn btn-warning"><a href="{{ route('living') }}">Подробнее-></a></div>
            </div>
            <div class="card text-white bg-dark mb-3">
                ...
                <div class="btn btn-warning"><a href="{{ route('children') }}">Подробнее-></a></div>
            </div>
        </div>
    </div>
@endsection
